        ...
        <center>
            <nav>
                <div class="nav-wrapper blue lighten-2">
                    <a href="index.php" class="brand-logo center"><img class="responsive-img" style="width: 250px;" src="https://i.imgur.com/ax0NCsK.gif" /></a>
                    ...
                    <form class="col s12" method="post">
                        ...
                        <div class='row'>
                            ...
                            <label style='float: right;'>
                                <a href='#!'><b style='color: #f678a7;'>Forgot Password?</b></a>
                            </label>
                        </div>
                        <center>
                            <div class='row'>
